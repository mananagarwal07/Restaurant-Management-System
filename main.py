# Restaurant Management System with Tkinter
# This application provides a billing interface for restaurant staff with login/registration,
# dropdown-based item selection, a built-in calculator, PDF bill generation, and a clean ttk-based UI.
...
class LoginPage:
    def __init__(self, win):
        ...
        # Buttons for login/register/reset
